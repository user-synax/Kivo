...
// Native port of frontend/components/auth/OAuthButtons.jsx.
// Opens the backend start endpoint in a system-browser auth session;
// the backend finishes at the kivo://oauth/callback deep link.
export default function OAuthButtons({
  ...
  const btn =
    "h-12 flex-row items-center justify-center gap-2 rounded-xl border border-border bg-elevated px-3 active:opacity-80";
