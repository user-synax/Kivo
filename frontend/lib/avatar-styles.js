...
export const AVATAR_STYLES = [
  ...
  { id: "lime", label: "Lime", kind: "solid", color: "#7fee64", plus: true },
  { id: "blue", label: "Blue", kind: "solid", color: "#6c8cff", plus: true },
  { id: "rose", label: "Rose", kind: "solid", color: "#fb7185", plus: true },
  { id: "amber", label: "Amber", kind: "solid", color: "#f59e0b", plus: true },
  { id: "violet", label: "Violet", kind: "solid", color: "#a78bfa", plus: true },
  { id: "ocean", label: "Ocean", kind: "solid", color: "#38bdf8", plus: true },
  {
    id: "grad-sunset",
    label: "Sunset",
    kind: "gradient",
