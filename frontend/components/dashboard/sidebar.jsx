    ...
    return (
        <div className="flex h-full flex-col">
            ...
            >
                ...
                <div
                    className={`flex items-center gap-1 ${collapsed ? "" : ""}`}
                >
                    {onCompose && !collapsed && (
                        <button
                            type="button"
            ...
            {!collapsed && (
                <div className="shrink-0 px-3 py-2">
                    <div className="flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--bg-surface)] px-2.5 py-1.5 focus-within:border-[var(--accent)]">
                        ...
                        {query && (
                            <button
                                ...
                                className="flex size-5 shrink-0 items-center justify-center rounded text-[var(--text-muted)] transition-colors hover:bg-[var(--hover)] hover:text-[var(--text-primary)]"
                            ></button>
                        )}
                    </div>
                </div>
