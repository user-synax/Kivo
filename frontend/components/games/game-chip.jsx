...
export function GameChip({ game, viewerId }) {
  ...
  return (
    ...
    >
      <span className="flex size-7 shrink-0 items-center justify-center rounded-lg bg-[var(--accent)]/12 text-sm">
        {isResult ? <Trophy className="h-4 w-4 text-amber-500" /> : meta.emoji}
      </span>
