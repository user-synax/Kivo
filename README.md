...
- 👤 **Rich profiles** — display name, custom status, bio, banner, avatar uploads & frames, **country flag**, **GitHub contribution graph**, and **social link chips** (GitHub/X/Instagram/YouTube/website) on a public profile page (`/u/username`) — plus a one-tap **Wave 👋** ping on any profile.
